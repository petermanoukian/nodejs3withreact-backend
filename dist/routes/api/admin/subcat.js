...
const SubcatController_1 = require("../../../app/http/Controllers/Api/Admin/SubcatController");
const router = (0, express_1.Router)();
const subcatController = SubcatController_1.SubcatController.instance;
// ✅ Explicit routes
...
router.post("/store", SubcatController_1.SubcatController.uploadMiddleware, (req, res) => subcatController.store(req, res));
...
router.put("/update/:id", SubcatController_1.SubcatController.uploadMiddleware, (req, res) => subcatController.update(req, res));
